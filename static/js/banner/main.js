(function ($) {
  $(document).on('ready', function () {
        ...
        button.addEventListener('click', (e) => {
          ...
          if(action == 'delete'){
            ...
            modalBody.innerHTML = `
              ...
              <h5 class="fs-24 fw-bold">You are about to delete a banner.</h5>
              <div class="pt-3">
              <p class="fs-20 text-start">
                <span>Banner : <span><span class="font-weight-medium">`+messages[index].title+`</span>
              </p>
              <p class="fs-20 text-start">
                <span>Banner code : <span><span class="font-weight-medium">`+messages[index].no+`</span> 
              </p>
              </div>
            `;

            const href = 'banner.html'
          ...
          if(action == 'edit'){
            console.log('edit');
            window.location.href = "banner_form.html?id="+messages[index].no;
          }
    ...
    const columns = [
      { label: 'No', field: 'no' },
      { label: 'Title', field: 'title', width:400 },
    ...
    const messages = [
      { 
        no: '1',
        title: '<div class="d-flex flex-row text-wrap lh-1"><img class="img-fluid me-2" src="static/images/video/thumb.png"> Lorem Ipsum is simply dummy text of printing Lorem Ipsum is simply dummy text of printing.</div>',
