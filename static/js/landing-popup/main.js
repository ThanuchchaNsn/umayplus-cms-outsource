(function ($) {
  $(document).on('ready', function () {
        ...
        button.addEventListener('click', (e) => {
          ...
          if(action == 'delete'){
            ...
            modalBody.innerHTML = `
              ...
              <h5 class="fs-24 fw-bold">You are about to delete a landing page.</h5>
              <div class="pt-3">
              <p class="fs-20 text-start">
                <span>Landing Page : <span><span class="font-weight-medium">`+messages[index].title+`</span><br>
                <span>Landing Page code : <span><span class="font-weight-medium">`+messages[index].no+`</span> 
              </p>
              </div>
            `;

            const href = 'landing_popup.html'
          ...
          if(action == 'edit'){
            console.log('edit');
            window.location.href = "landing_popup_form.html?id="+messages[index].no;
          }
    ...
    const messages = [
      { 
        no: '1',
        title: '<div class="text-wrap lh-1">Lorem Ipsum is simply dummy text of printing.<div>',
        priority: '-',
