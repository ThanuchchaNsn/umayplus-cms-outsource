(function ($) {
  $(document).on('ready', function () {
      ...
      const modalYoutubeLink = document.getElementById('youtubeLinkModalCenter');
      const modalInstanceYoutubeLink = new mdb.Modal(modalYoutubeLink);
    ...
    $(document).on('click','.timepicker-submit',function(){
      ...
      $(document).on('click','.btn-add-youtube-link',function(){
          var valEmbedYoutubeID = setupToutubeID($('input[name="embedYoutubeURL"]').val());
          console.log(valEmbedYoutubeID);
          $('input[name="embedYoutube"]').val('//www.youtube.com/embed/'+valEmbedYoutubeID);
          $('.youtubeIframe').find('iframe').attr('src','//www.youtube.com/embed/'+valEmbedYoutubeID);
          modalInstanceYoutubeLink.hide();
      });
