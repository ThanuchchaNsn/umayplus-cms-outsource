        ...
        button.addEventListener('click', (e) => {
          ...
          if(action == 'delete'){
            ...
            modalBody.innerHTML = `
              ...
              <h5 class="fs-24 fw-bold">You are about to delete a video.</h5>
              <div class="pt-3">
              <p class="fs-20 text-start">
                <span>Video : <span><span class="font-weight-medium">`+messages[index].title+`</span>
                
              </p>
              <p class="fs-20 text-start">
                <span>Video code : <span><span class="font-weight-medium">`+messages[index].no+`</span> 
              </p>
              </div>
            `;

            const href = 'video.html'
          ...
          if(action == 'edit'){
            console.log('edit');
            window.location.href = "edit_form.html?id="+messages[index].no;
          }
