        ...
        button.addEventListener('click', (e) => {
          ...
          if(action == 'delete'){
            ...
            modalBody.innerHTML = `
              ...
              <h5 class="fs-24 fw-bold">You are about to delete a blog.</h5>
              <div class="pt-3">
              <p class="fs-20 text-start">
                <span>Blog : <span><span class="font-weight-medium">`+messages[index].title+`</span><br>
                <span>Blog code : <span><span class="font-weight-medium">`+messages[index].no+`</span> 
              </p>
              </div>
            `;
          ...
          if(action == 'edit'){
            console.log('edit');
            window.location.href = "blog_form.html?id="+messages[index].no;
          }
