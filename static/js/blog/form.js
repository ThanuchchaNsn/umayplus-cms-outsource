(function ($) {
  $(document).on('ready', function () {
    ...
    $(document).on('change', '.rssRowContainerButtons input[type="file"],.rssRowContainerSocialMedia input[type="file"],input[type="file"][name="imageBlog"],input[type="file"][name="bannerBlog"]', function (e) {
