(function ($) {
  $(document).on('ready', function () {
    ...
    $(document).on('change', '.rssRowContainerButtons input[type="file"],.rssRowContainerSocialMedia input[type="file"],input[type="file"][name="imagePromotion"],input[type="file"][name="bannerPromotion"]', function (e) {
