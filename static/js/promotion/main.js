        ...
        button.addEventListener('click', (e) => {
          ...
          if(action == 'delete'){
            ...
            modalBody.innerHTML = `
              ...
              <h5 class="fs-24 fw-bold">You are about to delete a promotion.</h5>
              <div class="pt-3">
              <p class="fs-20 text-start">
                <span>Promotion : <span><span class="font-weight-medium">`+messages[index].title+`</span><br>
                <span>Promotion code : <span><span class="font-weight-medium">`+messages[index].no+`</span> 
              </p>
              </div>
            `;

            const href = 'promotion.html'
          ...
          if(action == 'edit'){
            console.log('edit');
            window.location.href = "promotion_form.html?id="+messages[index].no;
          }
