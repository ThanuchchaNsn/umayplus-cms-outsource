...
class Datepicker {
  ...
  _closeModal() {
    var backdrop = SelectorEngine.findOne('.datepicker-backdrop');
    var datepicker = SelectorEngine.findOne('.datepicker-modal-container');
 


    // backdrop = SelectorEngine.findOne('.datepicker-backdrop');
    // datepicker = SelectorEngine.findOne('.datepicker-modal-container');
    ...
    // $('body > div.datepicker-backdrop.animation.fade-in').removeClass("datepicker-backdrop")
    $('.datepicker-backdrop').removeClass("datepicker-backdrop");
